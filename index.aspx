  ...
  <body>
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        <h1>
          Elegant Villas For<br />
          Elevated Lifestyles
        </h1>
        <button type="button" class="btn btn-warning btn-lg mt-3" data-mdb-ripple-init href="./gallery.html">
          Explore Villas
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M7.92768 6.99708L2.27082 12.6539L0.856608 11.2397L6.51346 5.58287L1.56371 0.633123H12.8774V11.9468L7.92768 6.99708Z"
              fill="#030E0F" />
          </svg>
        </button>
    ...
    <section id="gallery-section" class="gallery-section">
      <h1 class="mb-6">Explore Our Villas</h1>
      <div class="grid2">
        <!-- 12 Image Items -->
        <img src="/assets/images/1.jpg" alt="Image" />
        <img src="/assets/images/villas.png" alt="Image" />
        <img src="/assets/images/Container (3).png" alt="Image" />
        <img src="/assets/images/Container (2).png" alt="Image" />
        <img src="/assets/images/Container (4).png" alt="Image" />
        <img src="/assets/images/Container (5).png" alt="Image" />
      </div>
    </section>
    ...
    <section id="villas" class="villas">
      <div class="ts-container">
        <h1 class="mb-6">Our Exclusive Villa Collection</h1>
        <div class="VillaCollectiongrid mt-5">
          <!-- 12 Villa Images -->
          <div class="card">
            <img src="/assets/images/window.png" alt="Villa 2" />
            <div class="overlay">
